...
public final class OrderGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.linmour.order.grpc.Object,
      com.linmour.order.grpc.Result1> getCreateOrderMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "createOrder",
      requestType = com.linmour.order.grpc.Object.class,
      responseType = com.linmour.order.grpc.Result1.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.linmour.order.grpc.Object,
      com.linmour.order.grpc.Result1> getCreateOrderMethod() {
    io.grpc.MethodDescriptor<com.linmour.order.grpc.Object, com.linmour.order.grpc.Result1> getCreateOrderMethod;
      ...
      synchronized (OrderGrpc.class) {
        if ((getCreateOrderMethod = OrderGrpc.getCreateOrderMethod) == null) {
          OrderGrpc.getCreateOrderMethod = getCreateOrderMethod =
              io.grpc.MethodDescriptor.<com.linmour.order.grpc.Object, com.linmour.order.grpc.Result1>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "createOrder"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.linmour.order.grpc.Object.getDefaultInstance()))
  ...
  public static abstract class OrderImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void createOrder(com.linmour.order.grpc.Object request,
  ...
  public static final class OrderBlockingStub extends io.grpc.stub.AbstractBlockingStub<OrderBlockingStub> {
    ...
    /**
     */
    public com.linmour.order.grpc.Result1 createOrder(com.linmour.order.grpc.Object request) {
  ...
  public static final class OrderFutureStub extends io.grpc.stub.AbstractFutureStub<OrderFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.linmour.order.grpc.Result1> createOrder(
        com.linmour.order.grpc.Object request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CREATE_ORDER:
          serviceImpl.createOrder((com.linmour.order.grpc.Object) request,
              (io.grpc.stub.StreamObserver<com.linmour.order.grpc.Result1>) responseObserver);
          break;
        default:
