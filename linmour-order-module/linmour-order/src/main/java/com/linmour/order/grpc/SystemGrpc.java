...
public final class SystemGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.linmour.order.grpc.LongList,
      com.linmour.order.grpc.Result1> getGetShopByIdsMethod;
  ...
  public static io.grpc.MethodDescriptor<com.linmour.order.grpc.LongList,
      com.linmour.order.grpc.Result1> getGetShopByIdsMethod() {
    io.grpc.MethodDescriptor<com.linmour.order.grpc.LongList, com.linmour.order.grpc.Result1> getGetShopByIdsMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<com.linmour.order.grpc.LongList,
      com.linmour.order.grpc.Result1> getGetMerchantByIdsMethod;
  ...
  public static io.grpc.MethodDescriptor<com.linmour.order.grpc.LongList,
      com.linmour.order.grpc.Result1> getGetMerchantByIdsMethod() {
    io.grpc.MethodDescriptor<com.linmour.order.grpc.LongList, com.linmour.order.grpc.Result1> getGetMerchantByIdsMethod;
  ...
  public static abstract class SystemImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getShopByIds(com.linmour.order.grpc.LongList request,
    ...
    /**
     */
    public void getMerchantByIds(com.linmour.order.grpc.LongList request,
        io.grpc.stub.StreamObserver<com.linmour.order.grpc.Result1> responseObserver) {
  ...
  public static final class SystemBlockingStub extends io.grpc.stub.AbstractBlockingStub<SystemBlockingStub> {
    ...
    /**
     */
    public com.linmour.order.grpc.Result1 getShopByIds(com.linmour.order.grpc.LongList request) {
    ...
    /**
     */
    public com.linmour.order.grpc.Result1 getMerchantByIds(com.linmour.order.grpc.LongList request) {
      return blockingUnaryCall(
  ...
  public static final class SystemFutureStub extends io.grpc.stub.AbstractFutureStub<SystemFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.linmour.order.grpc.Result1> getShopByIds(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.linmour.order.grpc.Result1> getMerchantByIds(
        com.linmour.order.grpc.LongList request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_SHOP_BY_IDS:
          serviceImpl.getShopByIds((com.linmour.order.grpc.LongList) request,
              (io.grpc.stub.StreamObserver<com.linmour.order.grpc.Result1>) responseObserver);
          break;
        case METHODID_GET_MERCHANT_BY_IDS:
          serviceImpl.getMerchantByIds((com.linmour.order.grpc.LongList) request,
              (io.grpc.stub.StreamObserver<com.linmour.order.grpc.Result1>) responseObserver);
          break;
        default:
