...
public final class OrderGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.linmour.product.grpc.Object,
      com.linmour.product.grpc.Result1> getGetOrderInfoMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getOrderInfo",
      requestType = com.linmour.product.grpc.Object.class,
      responseType = com.linmour.product.grpc.Result1.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.linmour.product.grpc.Object,
      com.linmour.product.grpc.Result1> getGetOrderInfoMethod() {
    io.grpc.MethodDescriptor<com.linmour.product.grpc.Object, com.linmour.product.grpc.Result1> getGetOrderInfoMethod;
    if ((getGetOrderInfoMethod = OrderGrpc.getGetOrderInfoMethod) == null) {
      synchronized (OrderGrpc.class) {
        if ((getGetOrderInfoMethod = OrderGrpc.getGetOrderInfoMethod) == null) {
          OrderGrpc.getGetOrderInfoMethod = getGetOrderInfoMethod =
              io.grpc.MethodDescriptor.<com.linmour.product.grpc.Object, com.linmour.product.grpc.Result1>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getOrderInfo"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.linmour.product.grpc.Object.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.linmour.product.grpc.Result1.getDefaultInstance()))
              .setSchemaDescriptor(new OrderMethodDescriptorSupplier("getOrderInfo"))
              .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<com.linmour.product.grpc.Object,
      com.linmour.product.grpc.Result2> getCreateOrderMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "createOrder",
      requestType = com.linmour.product.grpc.Object.class,
      responseType = com.linmour.product.grpc.Result2.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.linmour.product.grpc.Object,
      com.linmour.product.grpc.Result2> getCreateOrderMethod() {
    io.grpc.MethodDescriptor<com.linmour.product.grpc.Object, com.linmour.product.grpc.Result2> getCreateOrderMethod;
    if ((getCreateOrderMethod = OrderGrpc.getCreateOrderMethod) == null) {
      synchronized (OrderGrpc.class) {
        if ((getCreateOrderMethod = OrderGrpc.getCreateOrderMethod) == null) {
          OrderGrpc.getCreateOrderMethod = getCreateOrderMethod =
              io.grpc.MethodDescriptor.<com.linmour.product.grpc.Object, com.linmour.product.grpc.Result2>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              ...
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.linmour.product.grpc.Object.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.linmour.product.grpc.Result2.getDefaultInstance()))
  ...
  public static abstract class OrderImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getOrderInfo(com.linmour.product.grpc.Object request,
        io.grpc.stub.StreamObserver<com.linmour.product.grpc.Result1> responseObserver) {
      asyncUnimplementedUnaryCall(getGetOrderInfoMethod(), responseObserver);
    }

    /**
     */
    public void createOrder(com.linmour.product.grpc.Object request,
        io.grpc.stub.StreamObserver<com.linmour.product.grpc.Result2> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.linmour.product.grpc.Object,
                com.linmour.product.grpc.Result1>(
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.linmour.product.grpc.Object,
                com.linmour.product.grpc.Result2>(
  ...
  public static final class OrderBlockingStub extends io.grpc.stub.AbstractBlockingStub<OrderBlockingStub> {
    ...
    /**
     */
    public com.linmour.product.grpc.Result1 getOrderInfo(com.linmour.product.grpc.Object request) {
    ...
    /**
     */
    public com.linmour.product.grpc.Result2 createOrder(com.linmour.product.grpc.Object request) {
      return blockingUnaryCall(
  ...
  public static final class OrderFutureStub extends io.grpc.stub.AbstractFutureStub<OrderFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.linmour.product.grpc.Result1> getOrderInfo(
        com.linmour.product.grpc.Object request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.linmour.product.grpc.Result2> createOrder(
        com.linmour.product.grpc.Object request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_ORDER_INFO:
          serviceImpl.getOrderInfo((com.linmour.product.grpc.Object) request,
              (io.grpc.stub.StreamObserver<com.linmour.product.grpc.Result1>) responseObserver);
          break;
        case METHODID_CREATE_ORDER:
          serviceImpl.createOrder((com.linmour.product.grpc.Object) request,
              (io.grpc.stub.StreamObserver<com.linmour.product.grpc.Result2>) responseObserver);
          break;
        default:
  ...
  private static abstract class OrderBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.linmour.product.grpc.GrpcService.getDescriptor();
    }
