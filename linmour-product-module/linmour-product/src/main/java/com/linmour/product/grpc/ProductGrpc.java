...
public final class ProductGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.linmour.product.grpc.LongList,
      com.linmour.product.grpc.Result1> getGetProductDetailsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getProductDetails",
      requestType = com.linmour.product.grpc.LongList.class,
      responseType = com.linmour.product.grpc.Result1.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.linmour.product.grpc.LongList,
      com.linmour.product.grpc.Result1> getGetProductDetailsMethod() {
    io.grpc.MethodDescriptor<com.linmour.product.grpc.LongList, com.linmour.product.grpc.Result1> getGetProductDetailsMethod;
      ...
      synchronized (ProductGrpc.class) {
        if ((getGetProductDetailsMethod = ProductGrpc.getGetProductDetailsMethod) == null) {
          ProductGrpc.getGetProductDetailsMethod = getGetProductDetailsMethod =
              io.grpc.MethodDescriptor.<com.linmour.product.grpc.LongList, com.linmour.product.grpc.Result1>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getProductDetails"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.linmour.product.grpc.LongList.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.linmour.product.grpc.LongList,
      com.linmour.product.grpc.Result2> getReduceInventoriesMethod;
  ...
  public static io.grpc.MethodDescriptor<com.linmour.product.grpc.LongList,
      com.linmour.product.grpc.Result2> getReduceInventoriesMethod() {
    io.grpc.MethodDescriptor<com.linmour.product.grpc.LongList, com.linmour.product.grpc.Result2> getReduceInventoriesMethod;
      ...
      synchronized (ProductGrpc.class) {
        if ((getReduceInventoriesMethod = ProductGrpc.getReduceInventoriesMethod) == null) {
          ProductGrpc.getReduceInventoriesMethod = getReduceInventoriesMethod =
              io.grpc.MethodDescriptor.<com.linmour.product.grpc.LongList, com.linmour.product.grpc.Result2>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
  ...
  public static abstract class ProductImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getProductDetails(com.linmour.product.grpc.LongList request,
    ...
    /**
     */
    public void reduceInventories(com.linmour.product.grpc.LongList request,
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.linmour.product.grpc.LongList,
  ...
  public static final class ProductBlockingStub extends io.grpc.stub.AbstractBlockingStub<ProductBlockingStub> {
     ...
     * </pre>
     */
    public com.linmour.product.grpc.Result1 getProductDetails(com.linmour.product.grpc.LongList request) {
    ...
    /**
     */
    public com.linmour.product.grpc.Result2 reduceInventories(com.linmour.product.grpc.LongList request) {
      return blockingUnaryCall(
  ...
  public static final class ProductFutureStub extends io.grpc.stub.AbstractFutureStub<ProductFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.linmour.product.grpc.Result1> getProductDetails(
        com.linmour.product.grpc.LongList request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.linmour.product.grpc.Result2> reduceInventories(
        com.linmour.product.grpc.LongList request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_PRODUCT_DETAILS:
          serviceImpl.getProductDetails((com.linmour.product.grpc.LongList) request,
              (io.grpc.stub.StreamObserver<com.linmour.product.grpc.Result1>) responseObserver);
          break;
        case METHODID_REDUCE_INVENTORIES:
          serviceImpl.reduceInventories((com.linmour.product.grpc.LongList) request,
              (io.grpc.stub.StreamObserver<com.linmour.product.grpc.Result2>) responseObserver);
          break;
        default:
