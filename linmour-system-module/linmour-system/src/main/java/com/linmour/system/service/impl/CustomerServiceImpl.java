...
public class CustomerServiceImpl  extends ServiceImpl<CustomerMapper, Customer> implements CustomerService {
    ...
    public Customer login(CustomerDto customer) {
        ...
        JsonNode json = Unirest.get("https://api.weixin.qq.com/sns/jscode2session?appid=wx2728606f5f2b4621&secret=9ecbe72e173907443e9742803a980533&js_code=" + customer.getCode() + "&grant_type=authorization_code").asJson().getBody();
