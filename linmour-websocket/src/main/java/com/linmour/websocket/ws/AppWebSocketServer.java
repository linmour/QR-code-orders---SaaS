...
public class AppWebSocketServer {
    ...
    @Resource
    private GrpcClientService3 a;

    //注入为空
    public static GrpcClientService3 grpcService;
    ...
    public void onMessage(String message, Session session) {
        ...
        if (StringUtils.isNotBlank(message)) {
            try {
                ...
                changeHandler.handleRequest(webSocketMap, jsonObject, recordMap, this,  session,grpcService);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
